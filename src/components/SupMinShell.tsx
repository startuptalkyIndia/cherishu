...
import { Shield, LayoutDashboard, Building2, Gift, UserCog, FileText, BarChart3, LogOut, Settings, Store, CreditCard } from "lucide-react";
...
const nav = [
  ...
  { href: "/sup-min/billing", label: "Billing", icon: CreditCard },
